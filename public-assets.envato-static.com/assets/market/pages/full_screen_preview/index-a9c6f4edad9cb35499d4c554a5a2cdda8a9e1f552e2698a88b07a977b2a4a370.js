!(function (e, t) {
  ...
  function O(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      g = me(h);
    if (g || (p > 1 && "string" == typeof h && !ye.checkClone && gt.test(h)))
  ...
  !(function () {
      ...
      if (!i && (p(t), (t = t || N), q)) {
        ...
        if (!(_[e + " "] || (H && H.test(e)))) {
          if (((d = e), (v = t), 1 === y && (Y.test(e) || Q.test(e)))) {
            for (
              ((v = (ie.test(e) && f(t.parentNode)) || t) == t && ye.scope) ||
                ((u = t.getAttribute("id"))
              ...
              (1 &
                (r =
                  (e.ownerDocument || e) == (t.ownerDocument || t)
                    ...
                    : 1) ||
              (!ye.sortDetached && t.compareDocumentPosition(e) === r)
    ...
    (d.prototype = E.filters = E.pseudos),
      (E.setFilters = new d()),
      (ye.sortStable = M.split("").sort(B).join("") === M),
      p(),
  ...
  (at = be.createDocumentFragment().appendChild(be.createElement("div"))),
    ...
    at.appendChild(st),
    (ye.checkClone = at.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (at.innerHTML = "<textarea>x</textarea>"),
    (ye.noCloneChecked = !!at.cloneNode(!0).lastChild.defaultValue),
    (at.innerHTML = "<option></option>"),
    (ye.option = !!at.lastChild);
  var ft = {
    thead: [1, "<table>", "</table>"],
  ...
  (ye.cors = !!on && "withCredentials" in on),
    (ye.ajax = on = !!on),
    ke.ajaxTransport(function (t) {
      var n, r;
      if (ye.cors || (on && !t.crossDomain))
        return {
          send: function (i, o) {
            var a,
              s = t.xhr();
  ...
  ke.ajaxSetup({
    ...
    ke.each(["top", "left"], function (e, t) {
      ke.cssHooks[t] = R(ye.pixelPosition, function (e, n) {
        if (n)
          return (n = M(e, t)), yt.test(n) ? ke(e).position()[t] + "px" : n;
      });
    }),
